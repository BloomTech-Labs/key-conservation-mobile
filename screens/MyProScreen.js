...
class MyProScreen extends React.Component {
	...
	delete = (id, type) => {
		...
		Alert.alert('Warning', message, [ { text: 'Yes', onPress: onPressFunction }, { text: 'No', style: 'cancel' } ]);
	};
	...
	render() {
		...
		return (
			<ScrollView>
				<ProfileHeader navigation={this.props.navigation} myProfile={true} profile={this.props.currentUserProfile} />
				<View />
				<View>
											...
											rightIcon={
												<Menu>
													...
													<MenuOptions customStyles={optionsStyles}>
														<MenuOption onSelect={() => this.delete(camp.update_id, 'update')}>
															<Text style={{ color: '#ff0a55', fontSize: 16 }}>Delete Update</Text>
														</MenuOption>
														<MenuOption onSelect={() => this.goToEditCampUpdate(camp)}>
															<Text style={{ color: '#000', fontSize: 16 }}>Edit Update Post</Text>
														</MenuOption>
													</MenuOptions>
												</Menu>
											}
										...
										<ListItem
											...
											rightIcon={
												<Menu>
													...
													/>
													<MenuOptions customStyles={optionsStyles}>
														<MenuOption onSelect={() => this.delete(camp.camp_id, 'campaign')}>
															<Text style={{ color: '#ff0a55', fontSize: 16 }}>Delete Campaign</Text>
														</MenuOption>
														<MenuOption onSelect={() => this.goToCreateCampUpdate(camp)}>
															<Text style={{ color: '#000', fontSize: 16 }}>Make Update Post</Text>
														</MenuOption>
														<MenuOption onSelect={() => this.goToEditCampaign(camp)}>
															<Text style={{ color: '#000', fontSize: 16 }}>Edit Post</Text>
														</MenuOption>
													</MenuOptions>
												</Menu>
											}
...
export default connect(mapStateToProps, { getProfileData, deleteCampaign, setCampaign, deleteCampaignUpdate })(
	MyProScreen,
);
