...
const ReviewYourInfoScreen = props => {
        ...
        const [isEditingActivityQuest, setIsEditingActivityQuest] = useState(
          false
        );
              ...
              <ScrollView style={styles.obBody}>
                ...
                {!isEditingBasicInfo ? (
                  <View style={styles.sectionContainer}>
                    ...
                    <View style={styles.basicInfoRow}>
                      <Text style={styles.basicInfoRowTitle}>
                        Donation Link
                      </Text>
                  ...
                  <View style={styles.sectionContainer}>
                    <View style={styles.obSectionHeader}>
                      ...
                      <TouchableOpacity
                        style={styles.editIcons}
                        onPress={() =>
                          setIsEditingOrgDetails(!isEditingOrgDetails)
                        }
                      >
                        <EditPencil width='23' height='23' />
                      </TouchableOpacity>
                ...
                {!isEditingActivityQuest ? (
                  <View style={styles.sectionContainer}>
                    ...
                    <View>
                      <Text style={styles.obSubtitleSm}>
                        In a brief statement, only 150 characters, tell us about
                        your organization.
                      </Text>
                    ...
                    <View>
                      <Text style={styles.obSubtitleSm}>
                        In more depth, tell us about your organization's
                        mission.
                      </Text>
                    ...
                    <View>
                      <Text style={styles.obSubtitleSm}>
                        What species and habitats does your organization
                        directly work in or with?
                      </Text>
                      <View style={styles.listContainer}>
                  ...
                  <NavigateButton
                    ...
                    onButtonPress={async () => {
                      if (
                        ...
                        Alert.alert(
                          'Oops',
                          'Please fill in all sections of form',
                          [{ text: 'Got it' }]
                        );
                      } else {
                        updateAirtable();
