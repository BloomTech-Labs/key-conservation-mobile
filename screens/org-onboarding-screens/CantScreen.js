			...
			<ScrollView>
				...
				<View>
					...
					/> */}
						...
						<View>
							<View style={{ width: '90%' }}>
								<Text style={styles.obText}>Guarantee that all of your requests will get support and funding.</Text>
							</View>
						</View>
					</View>
					<View style={styles.contentWrapper}>
						...
						<View style={{ width: '90%' }}>
							<Text style={styles.obText}>Provide your organization with internet access.</Text>
						</View>
					</View>
					<View style={styles.contentWrapper}>
						<View style={styles.iconWrapper}>
						...
						<View style={{ width: '90%' }}>
							<Text style={styles.obTextBottom}>Oversee work completed by skilled professionals.</Text>
						</View>
					</View>
				</View>
				<View>
