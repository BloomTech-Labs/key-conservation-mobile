        ...
        <View style={styles.contentWrapper}>
          ...
          <View style={{ width: '90%' }}>
            ...
            <Text style={styles.obTextBottom}>
              Complete your base profile while we verify your organization. Once
              approved, you'll receive a survey by email, followed by a welcome
              kit. Now you can go visible! Start adding connections and
              campaigns.
            </Text>
          </View>
        </View>
