				...
				<View style={styles.contentWrapper}>
					...
					<View style={{ width: '90%' }}>
						...
						<Text style={styles.obText}>
							You already know how Key Conservation can help connect you with individual contributors.
							That's why you're here! We'll keep it brief.
						</Text>
					</View>
				</View>
				<View style={styles.contentWrapper}>
					...
					<View style={{ width: '90%' }}>
						...
						<Text style={styles.obText}>
							Let's set up your account! You'll need to fill out a form, upload your credentials, and set
							up a profile on the following screens.
						</Text>
					</View>
				</View>
				<View style={styles.contentWrapper}>
					...
					<View style={{ width: '90%' }}>
						...
						<Text style={styles.obTextBottom}>
							Complete your base profile while we verify your organization. Once approved, you'll receive
							a survey by email, followed by a welcome kit.{' '}
							<Text style={styles.obTextBold}>
								Now you can go visible! Start adding connections and campaigns.
							</Text>
						</Text>
					</View>
				</View>
