            ...
            <View style={styles.contentWrapper}>
              ...
              <View style={{ width: '90%' }}>
                ...
                <Text style={styles.obText}>
                  You already know how Key Conservation can help connect you
            ...
            <View style={styles.contentWrapper}>
              ...
              <View style={{ width: '90%' }}>
                ...
                <Text style={[styles.obText, styles.obTextBottom]}>
                  Once your application has been approved, you'll receive a
                  survey by email followed by a welcome kit. Once the survey is
                  complete your organization will be live on the Key App and you
                  can start adding connections and campaigns!
                </Text>
              </View>
            </View>
          </View>
